  ...
  def create
    ...
    respond_to do |format|
      if @article_category.save
        format.html { redirect_to article_category_url(@article_category), notice: "Article category was successfully created." }
  ...
  def update
    respond_to do |format|
      if @article_category.update(article_category_params)
        format.html { redirect_to article_category_url(@article_category), notice: "Article category was successfully updated." }
